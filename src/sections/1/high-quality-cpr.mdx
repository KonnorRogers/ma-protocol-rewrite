...
<EMTLevel level="basic">
  <ul>
    <a style={{ padding: "0 0.25rem"}} href="/sections/1/routine-patient-care">1.0 Routine Patient Care</a>
    ...
    <li>Continue 2 minute cycles of uninterrupted chest compressions followed by
      AED analysis and shock for 4 cycles (8 minutes) </li>

...
route: /sections/1/1.0-routine-patient-care
...
- <u>
    DO NOT
  </u> allow sick or injured patients to walk or otherwise exert themselves. Use safe and proper
...
- Note that there is no such regulatory concept as a “lift-assist call.” Under 105 CMR 170.345 of
  the EMS System regulations, each EMS call – including but not limited to those cases in which no
  ...
  Protocol 7.5, and included in the PCR.
...
<br />
<br />
<h2 id="continuous-quality-improvement">
...
- For patients under 12 years old, the airway is in most cases best managed with a BVM or SGA. In
